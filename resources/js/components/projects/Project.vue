...
import Dialog from '../clients/Dialog.vue';
...
export default {
    ...
    created() {
      ...
      //  if(this.currentRouteName === 'timetracking') {
      //   this.isTimeTrackingRoute = true;
      // } else {
      //   this.isTimeTrackingRoute = false;
      // }
    },
      beforeUpdate() { 
       this.getCurrentRouteName();
